  ...
  <div class="font-mono">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-1">
      <div v-for="(value, index) in promptsData" :key="value.prompt_name" 
        class="bg-gray-200 dark:bg-black border border-gray-400 dark:border-gray-800 hover:border-gray-600 dark:hover:border-gray-500 transition-colors duration-200">
        <div class="p-1 bg-gray-300 dark:bg-gray-800 border-b border-gray-400 dark:border-gray-700 flex items-center justify-between">
          <div class="flex items-center">
            ...
            <span class="text-[10px] font-medium text-gray-800 dark:text-gray-200 uppercase truncate max-w-[150px]">{{ value.prompt_name }}</span>
          </div>
          <div class="flex items-center">
        ...
        <div class="p-1">
          <textarea v-model="promptsData[index].prompt_text" 
    ...
    <!-- Empty state -->
    <div v-if="promptsData.length === 0" class="text-center py-4 border border-dashed border-gray-400 dark:border-gray-800 mt-2">
...
.hack-indicator-red {
  background-color: #EF4444; /* red-500 - keeping red for error indicators */
  border-radius: 50%;
