<template>
  <section class="min-h-screen hack-bg bg-gray-100 dark:bg-gray-900">
      ...
      <div class="max-w-full mx-auto flex items-center justify-between px-2">
        <div>
          <div class="flex items-center">
            ...
            <h1 class="text-xl font-mono font-bold hack-title text-white dark:text-gray-200">COACH_ARTIE::PROMPTS</h1>
          </div>
        </div>
        <div class="flex items-center">
          <UButton
    ...
    <!-- Main Content -->
    <div class="max-w-full mx-auto mt-2 px-2">
      <div class="bg-gray-200 dark:bg-gray-900 border border-gray-300 dark:border-gray-800 rounded-none overflow-hidden">
        <div class="p-1 bg-gray-300 dark:bg-gray-800 border-b border-gray-400 dark:border-gray-700 flex items-center">
          ...
          <UIcon name="i-heroicons-chat-bubble-bottom-center-text" class="w-3 h-3 mr-1 text-gray-700 dark:text-gray-300" aria-hidden="true" />
          <h2 id="prompts-heading" class="font-mono text-xs font-semibold text-gray-800 dark:text-gray-200">SYSTEM_PROMPTS.dat</h2>
        </div>
        <div class="p-2">
          <PromptsView />
        </div>
